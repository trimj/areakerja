...
<section class="container m-auto" style="margin-top: 100px; margin-bottom: 200px;">
    <main class="container mx-auto">
        <div class="flex flex-row">
            <div class="w-1/2 flex-row hidden lg:flex">
                <div class="flex flex-col justify-end">
                    <img class="w-64 rounded-xl ml-auto m-4" src="{{asset('assets/public/images/tentangkami1.svg')}}" alt="">
                    <img class="w-64 rounded-xl ml-auto mx-4" src="{{asset('assets/public/images/tentangkami3.svg')}}" alt="">
                </div>
                <div class="flex items-center">
                    <img class="w-64 rounded-xl" src="{{asset('assets/public/images/tentangkami2.svg')}}" alt="">
                </div>
            </div>
        ...
        <div class="flex flex-col relative pb-10">
            <img src="{{asset('assets/public/images/logo.png')}}" alt="" class="absolute opacity-30 w-479px right-0 -top-40">
            <div>
                <div class="flex flex-col text-center">
                    ...
                    <div class="flex flex-row text-left w-11/12 mx-auto">
                        <div class="flex flex-col w-1/2 mr-16">
                            <img class="w-32" src="{{asset('assets/public/images/tentangkami4.svg')}}" alt="">
                        ...
                        <div class="flex flex-col w-1/2 ml-mr-16">
                            <img class="w-32" src="{{asset('assets/public/images/tentangkami5.svg')}}" alt="">
